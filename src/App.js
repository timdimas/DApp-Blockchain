...
import car from "./assets/img/Hyundai.jpg";
import phone from "./assets/img/phone.jpg";
import computer from "./assets/img/laptop.jpg";
                ...
                <div className="flex gap-12 flex-wrap md:flex-nowrap">
                    ...
                    <div className="border border-black/2 flex flex-col">
                        ...
                        <div className="w-2/3 self-center">
                            <img className="w-full" src={phone} alt="Car" />
                        </div>
                        <div className="flex justify-between">
                            <button
                    ...
                    <div className="border border-black/2 flex flex-col">
                        ...
                        <div className="self-center">
                            <img className="w-full" src={computer} alt="Car" />
                        </div>
                        <div className="flex justify-between">
                            <button
